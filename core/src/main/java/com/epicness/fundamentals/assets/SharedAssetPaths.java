...
public class SharedAssetPaths {
    ...
    public static final AssetDescriptor<Sound> EXPLOSIONSOUND_SOUND;
    ...
    public static final AssetDescriptor<Sprite> PIXEL_SPRITEx;
    ...
    static {
        ...
        ASSETS.add(EXPLOSIONSOUND_SOUND = new AssetDescriptor<>("fundamentals/audios/explosionSound.swav", Sound.class));
        ...
        ASSETS.add(PIXEL_SPRITEx = new AssetDescriptor<>("fundamentals/images/pixel.png", Sprite.class));
